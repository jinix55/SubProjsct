...
-- 공통 비밀번호 초기화 관리
DROP TABLE IF EXISTS T_PASSWORD_INIT CASCADE;
CREATE TABLE IF NOT EXISTS T_PASSWORD_INIT (
    PASSWORD_INIT_ID VARCHAR(16) NOT NULL COMMENT '초기화 ID'
  , COMPANY_NM VARCHAR(100) NOT NULL COMMENT '회사 명'
  , USER_NM VARCHAR(100) NOT NULL COMMENT '사용자 명'
  , USER_ID VARCHAR(32) NOT NULL COMMENT '사용자 ID'
  , INIT_CNT NUMERIC(9,0) NOT NULL COMMENT '카운트'
  , USE_YN VARCHAR(1) DEFAULT 'Y' COMMENT '사용 여부'
  , RGST_ID VARCHAR(32) NOT NULL COMMENT '등록 ID'
  , RGST_DT TIMESTAMP NOT NULL COMMENT '등록 일시'
  , MODI_ID VARCHAR(32) NOT NULL COMMENT '수정 ID'
...
ALTER TABLE T_PASSWORD_INIT ADD CONSTRAINT T_PASSWORD_INIT_PK PRIMARY KEY(PASSWORD_INIT_ID);
-- CREATE INDEX T_PASSWORD_INIT_IX1 ON T_PASSWORD_INIT(PASSWORD_INIT_ID);	
