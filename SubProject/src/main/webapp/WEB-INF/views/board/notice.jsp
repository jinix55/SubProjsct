...
<section class="content">
    ...
    <table class="tb01" summary="첫째줄은 순차적인 게시물 번호이며, 제목, 상태, 등록일에 대한 내용입니다.">
        ...
        <tr>
            <td scope="row">1</td>
            <td class="tl"><a href="#공지사항상세url">[중요] 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지 빅데이터 포털 오픈 공지</a></td>
            <td>게시</td>
            <td>2020.10.13</td>
        </tr>
        <tr>
            <td scope="row">2</td>
            <td class="tl"><a href="#공지사항상세url">[중요] 빅데이터 포털 오픈 공지</a></td>
            <td>게시</td>
            <td>2020.10.13</td>
        </tr>
        <tr>
