...
INSERT INTO T_GROUP_AUTH (AUTH_ID,AUTH_CL,AUTH_NM,AUTH_DSC,USE_YN,RGST_ID,RGST_DT,MODI_ID,MODI_DT) VALUES
('au2000001','M','관리자','관리자','Y','SYSTEM',NOW(),'SYSTEM',NOW()),
('au2000002','A','분석관리자','분석관리자','Y','SYSTEM',NOW(),'SYSTEM',NOW());
