			...
			<div class="form-group">
				<div class="form-inline">
					<select class="select-box w150">
						...
						<option value="sj">내용</option>
						<option value="cn">내용</option>
						<option value="rgstId">등록자</option>
					</select>
				</div>
				<div class="form-inline">
...
<!-- 							<th><input type="checkbox" name="chk"></th> -->
							<c:choose>
								<c:when test="${list.importantYn eq 'Y'}">
									<th style="color: red;"></div></th>
								</c:when>
								<c:otherwise>
									<th></th>
								</c:otherwise>
							...
							<td class="tm text-point">${list.sj}</td>
							<td>${list.rgstId}</td>
<!-- 							<td>쓰기/읽기 권한</td> -->
			...
			<div class="row">
				<div class="col-50">
					<div class="form-group">
						...
						<div class="col-75">
							<div class="form-input">
								<input type="text" class="text-input" value="2010-10-23"
									disabled>
							</div>
						</div>
					</div>
