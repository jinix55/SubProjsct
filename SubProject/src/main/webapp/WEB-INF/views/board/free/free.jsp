								...
								<table class="table table-actions">
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="btn-group">
                          <a href="#detail" role="button" data-toggle="modal" class="btn-table-icon02"><img src="/images/icon_detail.png" alt="상세보기"></a>
													<a href="#edit" role="button" data-toggle="modal" class="btn-table-icon02"><img src="/images/icon_edit.png" alt="수정하기" class="btn-table-icon02"></a>
						              <a href="#delete" role="button" data-toggle="modal" class="btn-table-icon02"><img src="/images/icon_delete2.png" alt="삭제하기" class="btn-table-icon02"></a>
					              </div>
											</td>
										</tr>
										<tr>
...
<!-- 레이어 팝업 - 등록  -->
			...
			<div class="modal-content" style="width:400px">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-100">
							<div class="form-group">
								<div class="tc">(<em class="font-bold">Q&A</em>)삭제합니다.</div>
							</div>
						</div>
					</div>
				</div>
		...
		<div id="Alldelete" class="modal" data-backdrop-limit="1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-modal-parent="#myModal">
			...
			<div class="modal-content" style="width:400px">
	          ...
	          <div class="col-100">
							<div class="form-group">
								<div class="tc"><em class="font-bold">14 items selected</em><br />삭제하시겠습니까?</div>
							</div>
						</div>
					</div>
				</div>
