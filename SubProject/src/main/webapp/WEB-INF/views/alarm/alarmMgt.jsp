            ...
            <form>
                    ...
                    <label class="form-label-calendar">기간설정</label>
										<div class="search-date">
											<input type="text" id="datepicker" class="text-input">
										</div>~
										<div class="search-date">
											<input type="text" id="datepicker2" class="text-input">
										</div>
									</div>
								</div>
							</div>
								...
								<table class="table table-actions">
									...
									<tbody>
										<tr>
											...
											<td>2021-01-01</td>
											<td class="text-point">관리자</td>
											<td>휴가</td>
											<td class="ellipsis">10월25일부터11월30일까지 전체 유급휴가로 지정합니다. 모든 사원여러분 즐거운 휴가보내시길...</td>
											<td>
			...
			<div class="modal-content" style="width:400px">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-100">
							<div class="form-group">
								<div class="tc">(<em class="text-bold">2021-10-18</em>)삭제합니다.</div>
							</div>
						</div>
					</div>
				</div>
