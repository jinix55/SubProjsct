				...
				<tbody>
					<c:forEach var="alarm" items="${alarms}" varStatus="status">
						<tr>
							...
							<td>
								<div class="btn-group">
									<a href="#detail" onclick="detailView('${alarm.alarmId}');" role="button" data-toggle="modal" class="btn-table-icon02"><img src="/images/icon_detail.png" alt="상세보기" class="btn-table-icon02"></a>
								</div>
							</td>
						</tr>
					</c:forEach>
