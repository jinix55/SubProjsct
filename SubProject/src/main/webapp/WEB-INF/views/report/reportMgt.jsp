								...
								<div class="form-group">
									<div class="form-inline">
											<select class="select-box w150">
												<option value="0">레포트 ID</option>
												<option value="1">레포트 명</option>
											</select>
									</div>
									<div class="form-inline">
								...
								<table class="table table-actions">
									...
									<tbody>
										<tr>
											...
											<td>1</td>
											<td class="tl text-point">GROUP_00000000000353</td>
											<td>CNCT_TEST</td>
											<td>태블로</td>
											<td class="ellipsis" title="file:///C:/Users/ms.kim5/Desktop/new%ED%94%84%EB%A0%88%EC%9E%84%EC%9B%8D/html/report/ReportMgt.html">file:///C:/Users/ms.kim5/Desktop/new%ED%94%84%EB%A0%88%EC%9E%84%EC%9B%8D/html/report/ReportMgt.html</td>
											<td>
			...
			<div class="modal-content" style="width:800px">
				...
				<div class="modal-body">
							...
							<div class="form-group">
								...
								<div class="col-75">
										<select class="select-box">
											<option value="010">태블로</option>
											<option value="011">로그프레소</option>
										</select>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-100">
							<div class="form-group">
								<label class="col-25 form-label">사용자 그룹</label>
								<div class="col-75">
									<div class="form-input-box">
										<label>GROUP_01<input type="checkbox" name="chk"></label>
										<label>GROUP_02<input type="checkbox" name="chk"></label>
										<label>GROUP_03<input type="checkbox" name="chk"></label>
										<label>GROUP_04<input type="checkbox" name="chk"></label>
										<label>GROUP_05<input type="checkbox" name="chk"></label>
										<label>GROUP_06<input type="checkbox" name="chk"></label>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-75 row">
										<div class="col-20-dev">
												<input type="text" class="text-input" value="1320x700">
										</div>
			...
			<div class="modal-content" style="width:800px">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-50">
								<div class="form-group">
									...
									<div class="col-75">
										<div class="form-input">
											<input type="text" class="text-input" value="2010-10-02" disabled>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-50">
								<div class="form-group">
									<label class="col-25 form-label">레포트 ID</label>
									<div class="col-75">
										<div class="form-input">
											<input type="text" class="text-input" value="레포트 ID" disabled>
										</div>
									</div>
								</div>
							</div>
							<div class="col-50">
								<div class="form-group">
									<label class="col-25 form-label">레포트 명</label>
									<div class="col-75">
								 	 <div class="form-input">
								 		 <input type="text" class="text-input" value="레포트 명" disabled>
								 	 </div>
								  </div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-50">
								<div class="form-group">
									<label class="col-25 form-label">연동 구분</label>
									<div class="col-75">
										<div class="form-input">
											<input type="text" class="text-input" value="태블로" disabled>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-100">
								<div class="form-group">
									...
									<div class="col-75">
										<div class="form-input">
											<input type="text" class="text-input" value="GROUP_01,GROUP_02" disabled>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-75 row">
											<div class="col-20-dev">
													<input type="text" class="text-input" value="1320x700" disabled>
											</div>
											<div class="col-75 pl05">
												<div class="form-input">
													<input type="text" class="text-input" value="http://wwww.Platfrom.com" disabled>
												</div>
											</div>
									</div>
								</div>
				...
				<!-- 버튼 -->
				<div class="modal-footer btn-group">
					<button type="button" class="button btn-success" data-dismiss="modal">확인</button></div>
			</div>
		</div>
		<!-- 레이어 팝업 - 수정 -->
						...
						<div class="row">
							<div class="col-50">
								<div class="form-group">
									...
									<div class="col-75">
										<div class="form-input">
											<input type="text" class="text-input" value="레포트 ID">
										</div>
									</div>
								</div>
							</div>
							<div class="col-50">
								<div class="form-group">
									...
									<div class="col-75">
									 <div class="form-input">
										 <input type="text" class="text-input" value="레포트 명">
									 </div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-100">
								<div class="form-group">
									...
									<div class="col-75">
										<div class="form-input-box">
											<label>GROUP_01<input type="checkbox" name="chk" checked></label>
											<label>GROUP_02<input type="checkbox" name="chk" checked></label>
											<label>GROUP_03<input type="checkbox" name="chk"></label>
											<label>GROUP_04<input type="checkbox" name="chk"></label>
											<label>GROUP_05<input type="checkbox" name="chk"></label>
											<label>GROUP_06<input type="checkbox" name="chk"></label>
								...
								<div class="form-group">
									...
									<div class="col-75 row">
											...
											<div class="col-75 pl05">
												<div class="form-input">
													<input type="text" class="text-input" value="http://wwww.Platfrom.com">
												</div>
											</div>
									</div>
								</div>
